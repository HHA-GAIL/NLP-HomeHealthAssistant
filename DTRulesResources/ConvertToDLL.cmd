...
ikvmc -target:library DTRules2NLP/dist/lib/aspectjrt.jar -out:DLLs/aspectjrt.dll
ikvmc -target:library DTRules2NLP/dist/lib/JFlex.jar -out:DLLs/JFlex.dll
ikvmc -target:library DTRules2NLP/dist/lib/mysql-connector-java-5.0.8.jar -out:DLLs/mysql-connector.dll -r:DLLs/aspectjrt.dll
...
ikvmc -target:library DTRules2NLP/dist/DTRules2NLP.jar -out:DLLs/DTRules2NLP.dll -r:DLLs/JFlex.dll -r:DLLs/java-cup-10k.dll  -r:DLLs/poi-3.7.dll -r:DLLs/mysql-connector.dll
