...
public class MyListTest extends ATestHarness {
    ...
    public String   getRuleSetName()          { return "listtest";                }
    public String   getDecisionTableName()    { return "Test_Patient_List";           }
    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }
    public String   getTestDirectory()		  { return getPath()+"listtest/";             }
	
    public static void main(String[] args) {
    	MyListTest mt = new MyListTest();
        ITestHarness t = mt;
        mt.prtRelativeMsg();
        t.runTests();
    }
