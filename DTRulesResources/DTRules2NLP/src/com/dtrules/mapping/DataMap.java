...
//        System.out.println("opening tag, map.dataobject.size: "+map.dataObjects.size());
//        System.out.println(obj.getClass().getName()+"=="+tag);
//        Iterator iter = map.dataObjects.entrySet().iterator();
//        while (iter.hasNext()) {
...
//            else
//            {
//                System.out.println(entry.getKey()+"-->not null..."+((ArrayList<DataObjectMap>)val).size());
//                for(DataObjectMap DO : (ArrayList<DataObjectMap>)val)
//                    System.out.print(DO.tag+"--");
//                System.out.println("");
//            }
//        }
