...
public abstract class Reactive implements Runnable {
    ...
    public void runCurrentNode() {
        ...
        /**
         * @author: Fan Hu
         * @function: add toUpperCase to avoid the mistake when recognizing the
         * family relationship
         * @date: 03/27/2017
         */
        ...
        /**
         * @author: Fan Hu
         * @function: add store file function
         * @date: 06/14/2017
         */
        System.out.println(question + ", " + answer);
        String fileName = "log_conversation_";

        Date now = new Date();
        SimpleDateFormat dt = new SimpleDateFormat("yyyy-MM-dd");
        String dataString = dt.format(now);

        fileName += dataString;

        try {
            FileUtils.creatTxtFile(fileName);
            FileUtils.writeTxtFile(question);
            FileUtils.writeTxtFile(answer);
            FileUtils.writeTxtFile("");
        } catch (IOException ex) {
            Logger.getLogger(Reactive.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        /**
         * @author: Fan Hu
         * @function: add toUpperCase to ignore the spelling mistake, and add
         * throw exception function to give some specific suggestions
         * @date: 03/27/2017
         */
